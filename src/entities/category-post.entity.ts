...
export class CategoryPost {
  ...
  @ManyToOne(() => Category, category => category.categoryPosts, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
  @JoinColumn({ name: 'category_id' })
  category: Category;

  @ManyToOne(() => Post, post => post.categoryPosts, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
